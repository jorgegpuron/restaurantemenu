...
## El precio en chapa y un filete bajo el nombre (26 Aug 2026)

Dos rondas de prototipo sobre el texto de la ficha, con la foto y su degradado intactos. Primero
tres maneras de tratar nombre y precio —**Cartel** (nombre enorme, precio debajo en el metal),
**Chapa** (precio en pastilla de crema) y **Renglón** (nombre, puntos y precio en una línea)—, y
después tres aires distintos entre el nombre y la descripción dentro de la elegida.

### La chapa

El precio deja de ser texto blanco y pasa a una **pastilla de crema con la tinta encima**. Sobre
una foto, un número blanco más entre otras palabras blancas hay que buscarlo; una chapa se ve sin
buscarla, que es lo que se hace con un precio.

Dos medidas que costaron una vuelta:

- La chapa se alinea con la **primera línea del nombre** (`margin-top:-1px`), no con el borde de
  la caja del texto. Colgada del borde parecía un globo suelto.
- Y lleva `line-height:1.2` **a propósito**: la carta hereda un interlineado de lectura que dentro
  de una pastilla la hinchaba de 32 a 40 px y la descuadraba con el nombre.

En oferta, el precio de antes va tachado dentro de la misma chapa, en `.76em` al 55%.

### El filete

Entre el nombre y la descripción, una raya de 1 px al 32% de blanco con **11 px por lado**. Hace
el trabajo de un escalón de 21 con la mitad de aire, y encima de una foto se agradece cada píxel
que no se tapa. Es además la misma idea que separa los platos en la carta.

Medido: 13 px de hueco visible por arriba y 11 por abajo — arriba manda la altura de la chapa, que
es la pieza más alta de esa línea.

**Sin descripción, el filete se esconde**: una raya suelta debajo del nombre no separa nada y se
lee como un error de maquetado.

### Y sin foto, todo se deshace

Ninguna ficha se abre hoy sin foto, pero la regla está escrita: sobre papel la chapa desaparece
—una pastilla de crema sobre papel de crema no es una chapa, es un número que no se ve— y el
precio vuelve a ser texto en el acento, el filete pasa al color de los filetes de la carta y la
descripción a `--muted`.

### Comprobado corriendo

Chapa de 32 px alineada al píxel con la primera línea del nombre; filete visible con 13 y 11 de
aire; el bloque de texto mide 154 px sobre una foto de 550. Cero errores en consola.

**No hubo capturas**: el panel del navegador estaba cerrado y no compone imagen. Todo lo de arriba
está medido sobre la página corriendo, no leído del código.
